...
```{r q3.2-2}
# You can use 0 and 1
select.seq.unscrambled <- as.numeric(lm.est.eps > 0)
head(select.seq.unscrambled, 30)

# Or you can just keep it T and F
select.seq.unscrambled <- lm.est.eps > 0

lm.sub.pos <- lm.data[select.seq.unscrambled,]
```
